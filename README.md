...
Project Description:
*This repository contains files related to a 12-month (Sep 2025 - Sep 2026) 20/50 EMA crossover trend-following strategy on Reliance Industries Limited stock using the 1D timeframe on the NSE.

*The purpose of this project was to analyze and assess the viaability of a daily EMA crossover trading strategy on a single stock over the course of one year.
